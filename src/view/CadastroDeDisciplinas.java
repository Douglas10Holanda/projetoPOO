 ...
 * @author Douglas
 */
public class CadastroDeDisciplinas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCred.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCredActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtDisciplina, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtCred, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(52, 52, 52)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Seme, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtCredActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCredActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCredActionPerformed
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        Object[] dados = {txtDisciplina.getText(),txtCred.getText(),Seme.getText()};
...
//        System.out.println("Linha selecionada" + jTProdutos.getSelectedRow()); 
    ...
    private void jTProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTProdutosMouseClicked
        // TODO add your handling code here:
        if(jTProdutos.getSelectedRow() != -1){
            txtDisciplina.setText(jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 0).toString());
            txtCred.setText(jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 1).toString());
            Seme.setText(jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 2).toString());
        }
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        // TODO add your handling code here:
        if(jTProdutos.getSelectedRow() != -1){
            jTProdutos.setValueAt(txtDisciplina.getText(), jTProdutos.getSelectedRow(), 0);
            jTProdutos.setValueAt(txtCred.getText(), jTProdutos.getSelectedRow(), 1);
            jTProdutos.setValueAt(Seme.getText(), jTProdutos.getSelectedRow(), 2);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroDeDisciplinas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroDeDisciplinas().setVisible(true);
            }
        });
    }
